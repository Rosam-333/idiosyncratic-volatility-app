...
st.sidebar.caption("Extended build: multi-source news, prediction details, and forward sense-check. For the Yahoo-only core lab, use **`app.py`** (or `app_classic.py` — same app).")
